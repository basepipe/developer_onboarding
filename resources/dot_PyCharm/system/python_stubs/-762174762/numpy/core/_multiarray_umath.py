...
DATETIMEUNITS = None # (!) real value is '<PyCObject object at 0x0000000003AA2480>'

typeinfo = {
    'BOOL': None, # (!) real value is "numpy.core.multiarray.typeinforanged(char='?', num=0, bits=8, alignment=1, max=1, min=0, type=<type 'numpy.bool_'>)"
    'BYTE': None, # (!) real value is "numpy.core.multiarray.typeinforanged(char='b', num=1, bits=8, alignment=1, max=127, min=-128, type=<type 'numpy.int8'>)"
    'CDOUBLE': None, # (!) real value is "numpy.core.multiarray.typeinfo(char='D', num=15, bits=128, alignment=8, type=<type 'numpy.complex128'>)"
    'CFLOAT': None, # (!) real value is "numpy.core.multiarray.typeinfo(char='F', num=14, bits=64, alignment=4, type=<type 'numpy.complex64'>)"
    'CLONGDOUBLE': None, # (!) real value is "numpy.core.multiarray.typeinfo(char='G', num=16, bits=128, alignment=8, type=<type 'numpy.complex128'>)"
    'Character': None, # (!) real value is "<type 'numpy.character'>"
    'ComplexFloating': None, # (!) real value is "<type 'numpy.complexfloating'>"
    'DATETIME': None, # (!) real value is "numpy.core.multiarray.typeinforanged(char='M', num=21, bits=64, alignment=8, max=9223372036854775807L, min=-9223372036854775808L, type=<type 'numpy.datetime64'>)"
    'DOUBLE': None, # (!) real value is "numpy.core.multiarray.typeinfo(char='d', num=12, bits=64, alignment=8, type=<type 'numpy.float64'>)"
    'FLOAT': None, # (!) real value is "numpy.core.multiarray.typeinfo(char='f', num=11, bits=32, alignment=4, type=<type 'numpy.float32'>)"
    'Flexible': None, # (!) real value is "<type 'numpy.flexible'>"
    'Floating': None, # (!) real value is "<type 'numpy.floating'>"
    'Generic': None, # (!) real value is "<type 'numpy.generic'>"
    'HALF': None, # (!) real value is "numpy.core.multiarray.typeinfo(char='e', num=23, bits=16, alignment=2, type=<type 'numpy.float16'>)"
    'INT': None, # (!) real value is "numpy.core.multiarray.typeinforanged(char='i', num=5, bits=32, alignment=4, max=2147483647, min=-2147483648, type=<type 'numpy.int32'>)"
    'INTP': None, # (!) real value is "numpy.core.multiarray.typeinforanged(char='p', num=9, bits=64, alignment=8, max=9223372036854775807L, min=-9223372036854775808L, type=<type 'numpy.int64'>)"
    'Inexact': None, # (!) real value is "<type 'numpy.inexact'>"
    'Integer': None, # (!) real value is "<type 'numpy.integer'>"
    'LONG': None, # (!) real value is "numpy.core.multiarray.typeinforanged(char='l', num=7, bits=32, alignment=4, max=2147483647, min=-2147483648, type=<type 'numpy.int32'>)"
    'LONGDOUBLE': None, # (!) real value is "numpy.core.multiarray.typeinfo(char='g', num=13, bits=64, alignment=8, type=<type 'numpy.float64'>)"
    'LONGLONG': None, # (!) real value is "numpy.core.multiarray.typeinforanged(char='q', num=9, bits=64, alignment=8, max=9223372036854775807L, min=-9223372036854775808L, type=<type 'numpy.int64'>)"
    'Number': None, # (!) real value is "<type 'numpy.number'>"
    'OBJECT': None, # (!) real value is "numpy.core.multiarray.typeinfo(char='O', num=17, bits=64, alignment=8, type=<type 'numpy.object_'>)"
    'SHORT': None, # (!) real value is "numpy.core.multiarray.typeinforanged(char='h', num=3, bits=16, alignment=2, max=32767, min=-32768, type=<type 'numpy.int16'>)"
    'STRING': None, # (!) real value is "numpy.core.multiarray.typeinfo(char='S', num=18, bits=0, alignment=1, type=<type 'numpy.string_'>)"
    'SignedInteger': None, # (!) real value is "<type 'numpy.signedinteger'>"
    'TIMEDELTA': None, # (!) real value is "numpy.core.multiarray.typeinforanged(char='m', num=22, bits=64, alignment=8, max=9223372036854775807L, min=-9223372036854775808L, type=<type 'numpy.timedelta64'>)"
    'UBYTE': None, # (!) real value is "numpy.core.multiarray.typeinforanged(char='B', num=2, bits=8, alignment=1, max=255, min=0, type=<type 'numpy.uint8'>)"
    'UINT': None, # (!) real value is "numpy.core.multiarray.typeinforanged(char='I', num=6, bits=32, alignment=4, max=4294967295L, min=0, type=<type 'numpy.uint32'>)"
    'UINTP': None, # (!) real value is "numpy.core.multiarray.typeinforanged(char='P', num=10, bits=64, alignment=8, max=18446744073709551615L, min=0, type=<type 'numpy.uint64'>)"
    'ULONG': None, # (!) real value is "numpy.core.multiarray.typeinforanged(char='L', num=8, bits=32, alignment=4, max=4294967295L, min=0, type=<type 'numpy.uint32'>)"
    'ULONGLONG': None, # (!) real value is "numpy.core.multiarray.typeinforanged(char='Q', num=10, bits=64, alignment=8, max=18446744073709551615L, min=0, type=<type 'numpy.uint64'>)"
    'UNICODE': None, # (!) real value is "numpy.core.multiarray.typeinfo(char='U', num=19, bits=0, alignment=4, type=<type 'numpy.unicode_'>)"
    'USHORT': None, # (!) real value is "numpy.core.multiarray.typeinforanged(char='H', num=4, bits=16, alignment=2, max=65535, min=0, type=<type 'numpy.uint16'>)"
    'UnsignedInteger': None, # (!) real value is "<type 'numpy.unsignedinteger'>"
    'VOID': None, # (!) real value is "numpy.core.multiarray.typeinfo(char='V', num=20, bits=0, alignment=1, type=<type 'numpy.void'>)"
}

_ARRAY_API = None # (!) real value is '<PyCObject object at 0x0000000003AA23C0>'
...
_UFUNC_API = None # (!) real value is '<PyCObject object at 0x0000000003AA23F0>'
