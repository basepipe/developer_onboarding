...
class QSocketNotifier(QObject):
    ...
    staticMetaObject = None # (!) real value is '<PySide.QtCore.QMetaObject object at 0x0000000003EF9208>'
    Type = None # (!) real value is "<type 'PySide.QtCore.QSocketNotifier.Type'>"
