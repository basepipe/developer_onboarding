...
class QPainterPath(__Shiboken.Object):
    ...
    CurveToDataElement = PySide.QtGui.QPainterPath.ElementType.CurveToDataElement
    CurveToElement = PySide.QtGui.QPainterPath.ElementType.CurveToElement
    Element = None # (!) real value is "<type 'PySide.QtGui.QPainterPath.Element'>"
    ElementType = None # (!) real value is "<type 'PySide.QtGui.QPainterPath.ElementType'>"
