...
class QStyleOptionProgressBar(QStyleOption):
    ...
    textVisible = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    StyleOptionType = None # (!) real value is "<type 'PySide.QtGui.QStyleOptionProgressBar.StyleOptionType'>"
    StyleOptionVersion = None # (!) real value is "<type 'PySide.QtGui.QStyleOptionProgressBar.StyleOptionVersion'>"
    Type = PySide.QtGui.QStyleOptionProgressBar.StyleOptionType.Type
    Version = PySide.QtGui.QStyleOptionProgressBar.StyleOptionVersion.Version
