...
class QGraphicsPixmapItem(QGraphicsItem):
    ...
    BoundingRectShape = PySide.QtGui.QGraphicsPixmapItem.ShapeMode.BoundingRectShape
    HeuristicMaskShape = PySide.QtGui.QGraphicsPixmapItem.ShapeMode.HeuristicMaskShape
    MaskShape = PySide.QtGui.QGraphicsPixmapItem.ShapeMode.MaskShape
    ShapeMode = None # (!) real value is "<type 'PySide.QtGui.QGraphicsPixmapItem.ShapeMode'>"
