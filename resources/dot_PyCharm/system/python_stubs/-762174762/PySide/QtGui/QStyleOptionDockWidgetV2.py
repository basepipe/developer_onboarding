...
class QStyleOptionDockWidgetV2(QStyleOptionDockWidget):
    ...
    StyleOptionVersion = None # (!) real value is "<type 'PySide.QtGui.QStyleOptionDockWidgetV2.StyleOptionVersion'>"
    Version = PySide.QtGui.QStyleOptionDockWidgetV2.StyleOptionVersion.Version
