...
class QStyleOptionFocusRect(QStyleOption):
    ...
    StyleOptionType = None # (!) real value is "<type 'PySide.QtGui.QStyleOptionFocusRect.StyleOptionType'>"
    StyleOptionVersion = None # (!) real value is "<type 'PySide.QtGui.QStyleOptionFocusRect.StyleOptionVersion'>"
    Type = PySide.QtGui.QStyleOptionFocusRect.StyleOptionType.Type
    Version = PySide.QtGui.QStyleOptionFocusRect.StyleOptionVersion.Version
