...
# imports
import pandas._libs.missing as missing # C:\Python27\lib\site-packages\pandas\_libs\missing.pyd
...
class Infinity(object):
    ...
    __dict__ = None # (!) real value is "dict_proxy({'__ne__': <cyfunction Infinity.<lambda> at 0x0000000003572108>, '__module__': 'pandas._libs.algos', '__weakref__': <attribute '__weakref__' of 'Infinity' objects>, '__qualname__': 'Infinity', '__le__': <cyfunction Infinity.<lambda> at 0x0000000003662F48>, '__gt__': <cyfunction Infinity.<lambda> at 0x00000000035721C8>, '__dict__': <attribute '__dict__' of 'Infinity' objects>, '__lt__': <cyfunction Infinity.<lambda> at 0x0000000003662E88>, '__eq__': <cyfunction Infinity.<lambda> at 0x0000000003572048>, '__doc__': ' provide a positive Infinity comparison method for ranking ', '__ge__': <cyfunction Infinity.<lambda> at 0x0000000003572288>})"
    __qualname__ = 'Infinity'
...
class NegInfinity(object):
    ...
    __dict__ = None # (!) real value is "dict_proxy({'__ne__': <cyfunction NegInfinity.<lambda> at 0x0000000003572588>, '__module__': 'pandas._libs.algos', '__weakref__': <attribute '__weakref__' of 'NegInfinity' objects>, '__qualname__': 'NegInfinity', '__le__': <cyfunction NegInfinity.<lambda> at 0x0000000003572408>, '__gt__': <cyfunction NegInfinity.<lambda> at 0x0000000003572648>, '__dict__': <attribute '__dict__' of 'NegInfinity' objects>, '__lt__': <cyfunction NegInfinity.<lambda> at 0x0000000003572348>, '__eq__': <cyfunction NegInfinity.<lambda> at 0x00000000035724C8>, '__doc__': ' provide a negative Infinity comparison method for ranking ', '__ge__': <cyfunction NegInfinity.<lambda> at 0x0000000003572708>})"
    __qualname__ = 'NegInfinity'
