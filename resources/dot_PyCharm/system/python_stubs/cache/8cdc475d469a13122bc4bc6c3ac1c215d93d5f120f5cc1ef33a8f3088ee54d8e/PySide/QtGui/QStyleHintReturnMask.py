...
class QStyleHintReturnMask(QStyleHintReturn):
    ...
    StyleOptionType = None # (!) real value is "<type 'PySide.QtGui.QStyleHintReturnMask.StyleOptionType'>"
    StyleOptionVersion = None # (!) real value is "<type 'PySide.QtGui.QStyleHintReturnMask.StyleOptionVersion'>"
