...
class QGraphicsScene(__PySide_QtCore.QObject):
    ...
    BackgroundLayer = PySide.QtGui.QGraphicsScene.SceneLayer.BackgroundLayer
    BspTreeIndex = PySide.QtGui.QGraphicsScene.ItemIndexMethod.BspTreeIndex
    ForegroundLayer = PySide.QtGui.QGraphicsScene.SceneLayer.ForegroundLayer
    ItemIndexMethod = None # (!) real value is "<type 'PySide.QtGui.QGraphicsScene.ItemIndexMethod'>"
    ItemLayer = PySide.QtGui.QGraphicsScene.SceneLayer.ItemLayer
    NoIndex = PySide.QtGui.QGraphicsScene.ItemIndexMethod.NoIndex
    SceneLayer = None # (!) real value is "<type 'PySide.QtGui.QGraphicsScene.SceneLayer'>"
    SceneLayers = None # (!) real value is "<type 'SceneLayers'>"
    staticMetaObject = None # (!) real value is '<PySide.QtCore.QMetaObject object at 0x0000000003F3C4C8>'
