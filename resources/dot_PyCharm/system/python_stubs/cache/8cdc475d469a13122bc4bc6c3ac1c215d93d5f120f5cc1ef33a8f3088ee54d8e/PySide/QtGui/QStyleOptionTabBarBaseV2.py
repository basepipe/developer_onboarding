...
class QStyleOptionTabBarBaseV2(QStyleOptionTabBarBase):
    ...
    StyleOptionVersion = None # (!) real value is "<type 'PySide.QtGui.QStyleOptionTabBarBaseV2.StyleOptionVersion'>"
    Version = PySide.QtGui.QStyleOptionTabBarBaseV2.StyleOptionVersion.Version
